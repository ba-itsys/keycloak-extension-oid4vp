...
class DcqlQueryBuilderTest {
    ...
    void build_singleSdJwtCredential_correctStructure() throws Exception {
        builder.addCredentialType(
                "dc+sd-jwt",
                "IdentityCredential",
                List.of(new DcqlQueryBuilder.ClaimSpec("given_name"), new DcqlQueryBuilder.ClaimSpec("family_name")));
    ...
    void build_singleMdocCredential_usesDoctype() throws Exception {
        builder.addCredentialType(
                "mso_mdoc", "org.iso.18013.5.1.mDL", List.of(new DcqlQueryBuilder.ClaimSpec("given_name")));
    ...
    void build_optionalClaims_generatesClaimSets() throws Exception {
        builder.addCredentialType(
                ...
                List.of(
                        ...
                        new DcqlQueryBuilder.ClaimSpec("email", true)));
    ...
    @Test
    void splitClaimPath_simplePath_returnsSimpleArray() {
        List<Object> path = DcqlQueryBuilder.splitClaimPath("given_name", "dc+sd-jwt", "IdentityCredential");
        assertThat(path).containsExactly("given_name");
    }

    @Test
    void splitClaimPath_nestedPath_splitsBySlash() {
        List<Object> path = DcqlQueryBuilder.splitClaimPath("address/street", "dc+sd-jwt", "IdentityCredential");
        assertThat(path).containsExactly("address", "street");
    }

    @Test
    void splitClaimPath_mdocFormat_prependsDocType() {
        List<Object> path = DcqlQueryBuilder.splitClaimPath("given_name", "mso_mdoc", "org.iso.18013.5.1.mDL");
        assertThat(path).containsExactly("org.iso.18013.5.1.mDL", "given_name");
    }

    @Test
    void splitClaimPath_numericSegment_parsedAsInt() {
        List<Object> path = DcqlQueryBuilder.splitClaimPath("items/0/name", "dc+sd-jwt", "Type");
    ...
    void fromMapperSpecs_createsBuilderCorrectly() throws Exception {
        ...
        specs.put(
                ...
                new DcqlQueryBuilder.CredentialTypeSpec(
                        "dc+sd-jwt", "IdentityCredential", List.of(new DcqlQueryBuilder.ClaimSpec("sub"))));
