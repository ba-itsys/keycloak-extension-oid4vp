...
public class Oid4vpResponseDecryptor {
    ...
    public record PreDecryptionResult(
            String state, String vpToken, String error, String errorDescription, String mdocGeneratedNonce) {
        static final PreDecryptionResult EMPTY = new PreDecryptionResult(null, null, null, null, null);
    }

    PreDecryptionResult tryPreDecrypt(
